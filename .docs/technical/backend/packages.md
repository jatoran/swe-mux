...
| `automation_registry.py` | control-plane enablement DAG: substrate/consumer deps, cycle-checked resolution, whether an entry `spends`, and the model-free starting set a new Project is offered | storage, execution |
