...
| `processes.py` | creation-causal descendant inspection/actions; versioned parent-walk/Job provenance; infrastructure reservation and ownership-conflict quarantine; Project-wide loopback registration, discovery, listener attribution, and route maps | proxy transport, authoritative ownership from PID alone |
