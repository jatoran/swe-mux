...
- Utility-drawer width is one device-local value. Selected tab and desktop expansion are
  device-local values keyed by Project; mobile overlay visibility is transient and cannot mutate
  the desktop expansion map.
