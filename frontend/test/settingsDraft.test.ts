...
test('draft comparison ignores key order but not values', () => {
...
test('project defaults normalize an absent profile to null before comparison', () => {
...
test('ignore-pattern parsing round-trips the draft text and normalization trims it', () => {
