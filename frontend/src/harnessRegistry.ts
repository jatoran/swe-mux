...
let installed: readonly HarnessDescriptor[] = [
  ...
  { name: 'pi', display_name: 'pi', level: 'managed', state_sources: ['hook', 'transcript'], measurement_source: 'transcript', capabilities: { observed: true, transcript: true, measurement: true, lifecycle_hooks: true, pty_delivery: true, external_usage: false, provider_accounts: false, repaints_scrollback: true } },
  { name: 'opencode', display_name: 'opencode', level: 'hooked', state_sources: ['hook'], measurement_source: 'none', capabilities: { observed: true, transcript: false, measurement: false, lifecycle_hooks: true, pty_delivery: true, external_usage: false, provider_accounts: false, repaints_scrollback: false } },
]
