    ...
    <section class="projects-manager" role="dialog" aria-modal="true" aria-label="Manage projects">
      ...
      <div class="projects-manager-body">
        ...
        <main>{selected?<>
          ...
          <div class="projects-manager-actions"><button class="primary" onClick={()=>onOpen(selected)}>Open workspace</button><button onClick={()=>onSettings(selected)}>Project settings</button><button onClick={()=>onNote(selected)}>Project note</button><button onClick={()=>onFiles(selected)}>Files</button></div>
        ...
        </>:<div class="projects-manager-empty"><strong>No Projects configured</strong><p>Add a folder-backed Project to begin.</p><button class="primary" onClick={onAdd}>+ Add project</button></div>}</main>
      </div>
    </section>
  </div>
}
